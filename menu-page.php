...
<div class="gap-header">
	...
	<div class="container">
		<div class="row header-title-container" id="featured-dishes">
			<h1>Our Best Selling Menus</h1>
			<p>Our menu has won numerous awards for best authentic cuisine</p>
		</div>
		<div class="gap-header"></div>
		<div class="row">
			<div class="col-md-4 box-img hover-item">
				...
				consequat.</p>
				<div class="view-text">
					<h4 class="hover-center"><span class="glyphicon glyphicon-search"></span> VIEW</h4>
				</div>
				<!-- <input type="submit" class="btn btn-a btn-sm"> -->
			</div>
			<div class="col-md-4 box-img hover-item" >
				<div class="relative box-img">
